  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed right-0 top-1/2 transform -translate-y-1/2 z-50 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-l-lg p-2 shadow-lg hover:bg-gray-50 transition-all duration-200 ${
          showLogPanel ? "translate-x-0" : "translate-x-0"
        }`}
        style={{ right: showLogPanel ? "320px" : "0px" }}
      >
        {showLogPanel ? <ChevronRight size={16} /> : <ChevronLeft size={16} />}
      </button>

      {/* Log panel */}
      <div
        className={`w-80 bg-gradient-to-b from-gray-50 to-blue-50 border-l border-gray-200 flex flex-col relative z-40 transition-transform duration-300 ease-in-out ${
